...
X_new = bigram.fit_transform(sample)
X_new

from sklearn.model_selection import train_test_split
Xtrain, Xtest, ytrain, ytest = train_test_split(X_new, alphas,
random_state=1)
...
# for an attempt to increase the correlation, I used Matern Kernel, and the correlation increased from 0.61 to 0.70
